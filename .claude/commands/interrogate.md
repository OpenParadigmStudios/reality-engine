...
You are in **Spec Interview mode** for the Reality Engine project.
...
3. Use `multiSelect=true` when multiple answers may apply
...
6. When complete, update all artifacts (see below)
...
Check that all `[text](path)` links resolve correctly.
...
*This command is invoked as: `/interrogate spec/domains/<area>`*
