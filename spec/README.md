# Reality Engine Specifications

This directory contains technical specifications for Reality Engine, structured for consumption by LLM-based coding agents during implementation.

---

## For Human Readers

If you're looking for human-friendly documentation about what Reality Engine is and how it works, see [`/docs/`](../docs/README.md) instead.
